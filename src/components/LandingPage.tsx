          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <button className="w-full sm:w-auto px-8 py-4 bg-white dark:bg-[#0F172A] border border-slate-200 dark:border-white/10 text-[#0B1220] dark:text-[#E2E8F0] rounded-full font-bold text-lg hover:bg-slate-50 dark:hover:bg-white/5 transition-all">
                  {t.ctaSecondary}
                </button>
              </div>
            </motion.div>
