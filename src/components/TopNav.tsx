      ...
      <div className="flex items-center gap-8">
        ...
        <div className="relative w-96 hidden lg:block">
          ...
          <input 
            ...
            className={cn(
              "w-full py-3 bg-slate-50/80 border border-slate-100 rounded-2xl text-sm focus:ring-4 focus:ring-primary/10 focus:bg-white focus:border-primary outline-none transition-all font-medium",
        ...
        <div className="flex items-center gap-6 border-r border-slate-200 pr-6">
          <div className="flex items-center gap-2">
            ...
            <button 
              ...
              className="w-10 h-10 flex items-center justify-center rounded-xl text-slate-500 hover:text-primary hover:bg-slate-50 transition-all font-black text-xs"
            >
              {isAr ? 'EN' : 'ع'}
            </button>
          </div>
          ...
          <div className="flex items-center gap-3 cursor-pointer group p-1.5 rounded-2xl hover:bg-slate-50 transition-all border border-transparent hover:border-slate-100">
            ...
            <button 
              onClick={onLogout}
              className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-error transition-all"
            >
              <LogOut size={16} />
            </button>
          </div>
